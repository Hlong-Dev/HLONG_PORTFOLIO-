    ...
    theme: {
        ...
        extend: {
            colors: {
                ...
                primary: {
                    DEFAULT: "#8F0D0D", // PastelRed from your CV
                    foreground: "hsl(var(--primary-foreground))",
                },
                secondary: {
                    DEFAULT: "#450808", // DarkPastelRed from your CV
                    foreground: "hsl(var(--secondary-foreground))",
                },
                accent: {
                    DEFAULT: "#E7D192", // GoldenEarth from your CV
                ...
                muted: {
                    DEFAULT: "#666666", // LightGrey from your CV
                    foreground: "hsl(var(--muted-foreground))",
                },
                slate: {
                    DEFAULT: "#2E2E2E", // SlateGrey from your CV
                },
                card: {
                ...
                code: {
                    DEFAULT: "#112233", // Dark blue for code
                },
                tech: {
                    DEFAULT: "#001B44", // Dark tech blue
                }
            },
            borderRadius: {
                lg: "var(--radius)",
            ...
            animation: {
                ...
                "caret": "caret .75s step-end infinite"
            },
            typography: {
                DEFAULT: {
                    css: {
